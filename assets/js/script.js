...
mainProject.addEventListener('click', () => {
    mainProject.innerHTML =
     ...
     <a href="https://github.com/monacoglynn/gp-mini-pet">Click to see more</a></h2>`
});
project2.addEventListener('click', () => {
    project2.innerHTML =
        `<h2>weather tracking app that saves your searched cities
    <a href="https://github.com/monacoglynn/weather-tracker">Click to see more</a></h2>`
})

project3.addEventListener('click', () => {
    project3.innerHTML =
        `<h2>challenge your knowledge with this quiz game
    <a href="https://github.com/monacoglynn/piano-quiz">Click to see more</a></h2>`
})
